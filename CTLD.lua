...
ctld.dropOffZones = {
    { "DropoffZone_BatumiPowerPlant", "none", 2},
    { "DropoffZone_BatumiAirBase", "none", 2},
    { "DropoffZone_Mahind", "none", 2},
    { "DropoffZone_Helvachauri", "none", 2}
}
            ...
            if _unit ~= nil then
                ...
                if _groupId then
                    ...
                    if ctld.addedTo[tostring(_groupId)] == nil then
                        ...
                        local _rootPath = missionCommands.addSubMenuForGroup(_groupId, "Sling Cargo")
                                        ...
                                        if ctld.isJTACUnitType(_crate.unit) == false
                                            ...
                                            if _crate.side == nil or (_crate.side == _unit:getCoalition()) then
                                                ...
                                                if(trigger.misc.getUserFlag(97) ~= 1) then
                                                    ...
                                                    trigger.action.outText("Cannot spawn crates, you are out of supply!", 10)
                                                end
                                            end
                                        end
                                    end
